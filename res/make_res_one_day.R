#=============================================#
#分析用のcsv作成スクリプト(one_day_30_minutes)#
#=============================================#
...
setwd("/Volumes/HDD2 1/tick_225/2016/bid/one_day_30_minutes_clm")
file <- dir()
...
#2015_before（7186なし）
setwd("/Volumes/HDD2 1/tick_225/2015_before/bid/one_day_30_minutes_before_bid_15_clm")
file <- dir()
...
df_bid_15_before<-dplyr::inner_join(df_bid_15_before, stock, by="stock")%>%
  ...
  dplyr::filter(stock!="3110"&stock!="8803"&stock!="2432"&stock!="1808"&stock!="8332"&stock!="7186"&stock!="6753"&stock!="7272"&stock!="8270"&stock!="8028"&stock!="4041"&stock!="4755"&stock!="6724")
#2015_after（7186なし）
setwd("/Volumes/HDD2 1/tick_225/2015_after/bid/one_day_30_minutes_after_bid_15_clm")
...
#ask
#2016
setwd("/Volumes/HDD2 1/tick_225/2016/ask/one_day_ask_30_minutes_clm")
...
df_ask_16<-dplyr::inner_join(df_ask_16, stock, by="stock")%>%
  ...
  dplyr::filter(stock!="3110"&stock!="8803"&stock!="2432"&stock!="1808"&stock!="8332"&stock!="7186"&stock!="6753"&stock!="7272"&stock!="8270"&stock!="8028"&stock!="4041"&stock!="4755"&stock!="6724")
#2015_before（7186なし）
setwd("/Volumes/HDD2 1/tick_225/2015_before/ask/one_day_30_minutes_ask_before_15_clm")
...
#2015_after（7186なし）
setwd("/Volumes/HDD2 1/tick_225/2015_after/ask/one_day_30_minutes_ask_after_15_clm")
file <- dir()
...
df_ask_15_after<-dplyr::inner_join(df_ask_15_after, stock, by="stock")%>%
  ...
  dplyr::filter(stock!="3110"&stock!="8803"&stock!="2432"&stock!="1808"&stock!="8332"&stock!="7186"&stock!="6753"&stock!="7272"&stock!="8270"&stock!="8028"&stock!="4041"&stock!="4755"&stock!="6724")
write.csv(df_bid_16, "bid_16_one_day_30_minutes_res.csv", quote=FALSE, row.names=FALSE)
write.csv(df_bid_15_before, "bid_15_before_one_day_30_minutes_res.csv", quote=FALSE, row.names=FALSE)
write.csv(df_bid_15_after, "bid_15_after_one_day_30_minutes_res.csv", quote=FALSE, row.names=FALSE)
write.csv(df_ask_16, "ask_16_one_day_30_minutes_res.csv", quote=FALSE, row.names=FALSE)
write.csv(df_ask_15_before, "ask_15_before_one_day_30_minutes_res.csv", quote=FALSE, row.names=FALSE)
write.csv(df_ask_15_after, "ask_15_after_one_day_30_minutes_res.csv", quote=FALSE, row.names=FALSE)
